...
const StaffList = () => {
  ...
  const fetchStaff = useCallback(async () => {
    ...
    try {
      ...
      const res = await staffApi.listStaff(params);
      setStaff(res.staff || []);
    } catch (err) {
  ...
  // Filter by status tab (search is performed on backend)
  ...
  return (
    ...
    >
      ...
      >
        <Box component="form" id="staff-form" onSubmit={handleSubmit} sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
